...
public class Dragon {
    ...
    public static Scene getScene() {
        ...
        Material dragonMaterial = new Material(new Vector3(0.1, 0.35, 0.8), new Vector3(0.8, 0.8, 0.8), 100, 1.5, 0);
        ...
        Material floorMaterial = new Material(new Vector3(0.9, 0.85, 0.75), new Vector3(0.1, 0.1, 0.1), 1, 1, 0);
        Material wallMaterial = new Material(new Vector3(0.95, 0.8, 0.5), new Vector3(0.1, 0.1, 0.1), 1, 1, 0);
