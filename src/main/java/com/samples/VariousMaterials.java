...
public class VariousMaterials {
    ...
    public static Scene getScene() {
        ...
        Material planeMaterial = new DielectricMaterial(new ImageTexture("res\\images\\checkerboard.jpg"), new Vector3(0.2, 0.2, 0.2), 10, 3, 0);
        ...
        triangle1.setUvA(new double[] {0, 1});
        triangle1.setUvB(new double[] {0, 0});
        triangle1.setUvC(new double[] {1, 0});

        triangle2.setUvA(new double[] {1, 0});
        triangle2.setUvB(new double[] {1, 1});
        triangle2.setUvC(new double[] {0, 1});


        Material sphereMaterial1 = new DielectricMaterial(new SolidColorTexture(new Vector3(1, 0.25, 0)), new Vector3(0.2, 0.2, 0.2), 10, 1, 0);
        Material sphereMaterial2 = new DielectricMaterial(new SolidColorTexture(new Vector3(0.4, 0.0, 0.75)), new Vector3(0.8, 0.8, 0.8), 100, 1, 0);
        Material sphereMaterial3 = new ConductorMaterial(new SolidColorTexture(new Vector3(0.3, 0.1, 0)), new Vector3(0.2, 0.2, 0.2), 100, 0.5);
        Material sphereMaterial4 = new DielectricMaterial(new SolidColorTexture(new Vector3(0, 0.0, 0.0)), new Vector3(0.2, 0.2, 0.2), 100, 1.3, 1);
        Material sphereMaterial5 = new DielectricMaterial(new SolidColorTexture(new Vector3(0.9, 0.1, 0.1)), new Vector3(0.2, 0.2, 0.2), 10, 1, 0);
        Material sphereMaterial6 = new DielectricMaterial(new SolidColorTexture(new Vector3(0.1, 0.9, 0.1)), new Vector3(0.8, 0.8, 0.8), 100, 1, 0);
        Material sphereMaterial7 = new ConductorMaterial(new SolidColorTexture(new Vector3(0, 0, 0)), new Vector3(1, 1, 1), 100, 1);
