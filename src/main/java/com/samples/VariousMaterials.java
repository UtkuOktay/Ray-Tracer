...
public class VariousMaterials {
    ...
    public static Scene getScene() {
        ...
        Material planeMaterial = new Material(new Vector3(0.1, 0.1, 0.15), new Vector3(0.2, 0.2, 0.2), 10, 3, 0);
        ...
        Material sphereMaterial1 = new Material(new Vector3(1, 0.25, 0), new Vector3(0.2, 0.2, 0.2), 10, 1, 0);
        Material sphereMaterial2 = new Material(new Vector3(0.4, 0.0, 0.75), new Vector3(0.8, 0.8, 0.8), 100, 1, 0);
        Material sphereMaterial3 = new Material(new Vector3(0.3, 0.1, 0), new Vector3(0.2, 0.2, 0.2), 100, 8, 0);
        Material sphereMaterial4 = new Material(new Vector3(0, 0.0, 0.0), new Vector3(0.2, 0.2, 0.2), 100, 1.3, 1);
        Material sphereMaterial5 = new Material(new Vector3(0.9, 0.1, 0.1), new Vector3(0.2, 0.2, 0.2), 10, 1, 0);
        Material sphereMaterial6 = new Material(new Vector3(0.1, 0.9, 0.1), new Vector3(0.8, 0.8, 0.8), 100, 1, 0);
        Material sphereMaterial7 = new Material(new Vector3(0.1, 0.1, 0.9), new Vector3(0.8, 0.8, 0.8), 100, 8, 0);
